...
def cat_image_or_placeholder(name: str) -> str:
    ...
    """
    img_path = os.path.join("images", "Zoolotopia", "Sheltopia", f"{name}1.webp")
...
# ---------------- Main ----------------
def main():
    st.set_page_config(page_title="Zoolotopia · sheltopia", layout="wide")
    ...
    cats = df[(df["Species"] == "Dog") & (df["Platform"].isin(["shelter"]))]
